...
import com.ostar.ota.service.FTPFileDownloadTask;
...
public final class FTPToolkit {
	...
	public static void download(FTPClient client, String remoteFileName,
			String localPath, long startPoint, FTPFileDownloadTask.MyFtpListener listener) throws Exception {
	...
	public static void upload(FTPClient client, File localfile,
			String remoteFolderPath, FTPFileDownloadTask.MyFtpListener listener) throws Exception {
	...
	public static void uploadListPath(FTPClient client,
			List<String> localFilePaths, String remoteFolderPath, FTPFileDownloadTask.MyFtpListener listener) throws Exception {
		remoteFolderPath = PathToolkit.formatPath4FTP(remoteFolderPath);
		try {
			client.changeDirectory(remoteFolderPath);
